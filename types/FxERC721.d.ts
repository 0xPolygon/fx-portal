...
interface FxERC721Interface extends ethers.utils.Interface {
  functions: {
    ...
    "setupMetaData(string,string)": FunctionFragment;
...
export class FxERC721 extends BaseContract {
