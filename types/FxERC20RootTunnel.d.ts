...
interface FxERC20RootTunnelInterface extends ethers.utils.Interface {
  functions: {
  ...
  events: {
    "FxDepositERC20(address,address,address,uint256)": EventFragment;
    "FxWithdrawERC20(address,address,address,uint256)": EventFragment;
    "TokenMappedERC20(address,address)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "FxDepositERC20"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "FxWithdrawERC20"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "TokenMappedERC20"): EventFragment;
}

export type FxDepositERC20Event = TypedEvent<
...
export type FxWithdrawERC20Event = TypedEvent<
  [string, string, string, BigNumber] & {
    rootToken: string;
    childToken: string;
    userAddress: string;
...
export type TokenMappedERC20Event = TypedEvent<
  [string, string] & { rootToken: string; childToken: string }
>;

export class FxERC20RootTunnel extends BaseContract {
  ...
  interface: FxERC20RootTunnelInterface;
  ...
  filters: {
    "FxDepositERC20(address,address,address,uint256)"(
    ...
    "FxWithdrawERC20(address,address,address,uint256)"(
      rootToken?: string | null,
    ...
    "TokenMappedERC20(address,address)"(
      rootToken?: string | null,
      childToken?: string | null
    ): TypedEventFilter<
      [string, string],
