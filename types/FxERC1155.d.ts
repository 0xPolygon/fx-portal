...
interface FxERC1155Interface extends ethers.utils.Interface {
  functions: {
    ...
    "setupMetaData(string)": FunctionFragment;
...
export class FxERC1155 extends BaseContract {
  ...
  callStatic: {
    ...
    setupMetaData(_uri: string, overrides?: CallOverrides): Promise<void>;
